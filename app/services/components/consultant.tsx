...
const ConsultantsService = () => {
  return (
    <section className="py-24 max-w-[1512px] px-8 mx-auto">
      <h2 className="text-[60px] font-bold leading-[72px] text-center opacity-[0.86] hover:scale-105 duration-200">
        Unlock the transformative potential of AI
      </h2>
      <p className="pt-5 text-[18px] opacity-[0.48] text-center">
      ...
      <div className="text-center pt-8">
        <ButtonSecondary title="Speak with Our Consultants" />
      </div>
